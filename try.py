...
# Quiz 5번
# occur_columns = pivot.filter(like='(발생)')
# catch_columns = pivot.filter(like="(검거)")

# pivot['검거율'] = (catch_columns / occur_columns) * 100


# for column in pivot.columns:
#     if '(발생)' in column:
#         occur_columns = column
# occur_columns = occur_columns
# print(occur_columns)
